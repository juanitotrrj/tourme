...
namespace AppStudio
{
    ...
    {
        public const string APP_NAME = "TourMe";
...
if (textSpoken.ToLower().Contains(  "makati" ))
{
RootFrame.Navigate( typeof (MainPage));
}
if (textSpoken.ToLower().Contains(  "manila" ))
{
    RootFrame.Navigate(typeof(MainPage));
}
if (textSpoken.ToLower().Contains(  "pasay" ))
{
    RootFrame.Navigate(typeof(MainPage));
}
if (textSpoken.ToLower().Contains("ayala"))
{
    RootFrame.Navigate(typeof(MainPage));
}
break ;
